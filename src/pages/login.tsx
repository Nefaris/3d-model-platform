      ...
      <section className='pb-24 xl:pb-32 overflow-hidden'>
        <div className='relative pt-24 pb-64 lg:pb-80 bg-darkBlueGray-500 text-center rounded-b-10xl'>
          ...
          <div className='container px-6 mx-auto'>
            <span className='relative z-10 inline-block py-3 px-7 mb-8 text-lg font-medium font-heading leading-5 text-indigo-500 border border-indigo-500 rounded-6xl'>Login to your account</span>
            <h2 className='mb-12 text-9xl md:text-10xl xl:text-11xl text-white leading-tight font-heading font-medium'>Lorem ipsum</h2>
            ...
            <div className='relative -mt-40 md:-mt-52 py-10 px-8 bg-white rounded-4xl shadow-lg'>
              <div className='py-10 px-6 border-2 border-gray-50 rounded-4xl'>
                <div className='max-w-md mx-auto'>
                  ...
                  <a className='block py-5 px-10 mx-auto w-full md:max-w-max text-xl leading-6 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl' href='#'>Login</a>
                </div>
              </div>
