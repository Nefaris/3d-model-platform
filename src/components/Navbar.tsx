            ...
            <div className='flex items-center mb-10 px-10'>
              ...
              <a className='text-gray-400 hover:text-gray-500 ml-auto' href='#'>
                <svg width={20} height={23} viewBox='0 0 20 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <path d='M1 18.0121H19' stroke='currentColor' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' />
                  <path d='M8.87891 22H10.8789' stroke='currentColor' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' />
                </svg>
              </a>
            </div>
            <div>
